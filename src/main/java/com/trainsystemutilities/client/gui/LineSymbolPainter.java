 ...
 * 共通の描画を行う。
 *
 * <p>呼び出し側は {@link com.manta.api.screen.JsonLayoutHandler#drawCanvas} 内から
...
public final class LineSymbolPainter {
    ...
    public static void draw(GuiGraphics g, int x, int y, int size, LineSymbol sym, Font font) {
        // ロジックは MCSS の生値版 (com.manta.api.render.LineSymbolPainter) に集約。
        // ここは LineSymbol 型を受ける TSU 向け薄いラッパー。
        com.manta.api.render.LineSymbolPainter.draw(g, x, y, size,
